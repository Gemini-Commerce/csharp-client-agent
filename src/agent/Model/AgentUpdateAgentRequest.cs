...
namespace agent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Agent_UpdateAgent_request")]
    public partial class AgentUpdateAgentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUpdateAgentRequest" /> class.
        /// </summary>
        /// <param name="payload">payload.</param>
        /// <param name="payloadMask">payloadMask.</param>
        public AgentUpdateAgentRequest(AgentUpdatePayload payload = default(AgentUpdatePayload), string payloadMask = default(string))
        {
        ...
        public AgentUpdatePayload Payload { get; set; }
