# agent - the C# library for the agent/service.proto
...
```
nuget pack -Build -OutputDirectory out agent.csproj
```
...
## Documentation for Models
 ...
 - [Model.AgentAgentEntity](docs/AgentAgentEntity.md)
 - [Model.AgentCreateAgentRequest](docs/AgentCreateAgentRequest.md)
 - [Model.AgentListAgentsRequest](docs/AgentListAgentsRequest.md)
 - [Model.AgentListResponse](docs/AgentListResponse.md)
 - [Model.AgentSortOrder](docs/AgentSortOrder.md)
 - [Model.AgentUpdateAgentRequest](docs/AgentUpdateAgentRequest.md)
 - [Model.AgentUpdatePayload](docs/AgentUpdatePayload.md)
 - [Model.ListRequestFilters](docs/ListRequestFilters.md)
 - [Model.ListRequestSort](docs/ListRequestSort.md)
